...
//为文章添加TAGS标签
if( get_option('superfastseo-tags-content') ==='1' ){
    include(SUPERFASTSEO_PLUGIN_DIR . '/functions/tagscontent.php');
}
//TAGS标签添加内链
if( get_option('superfastseo-tags-link') ==='1' ){
    include(SUPERFASTSEO_PLUGIN_DIR . '/functions/tagslink.php');
}
