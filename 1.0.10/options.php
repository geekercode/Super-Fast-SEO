...
function superfastseo_admin_menu(){
    ...
    add_submenu_page(
        'superfastseo','TAGS优化设置','TAGS优化设置','administrator','superfastseo_tags_set','superfastseo_tags_set_menu_callback'
    );
    add_submenu_page(
    ...
    add_submenu_page(
        'superfastseo','SMTP邮件设置','SMTP邮件设置','administrator','superfastseo_smtp_set','superfastseo_smtp_set_menu_callback'
    );
add_submenu_page(
        'superfastseo','生成 memcached 设置','Memcached 缓存设置','administrator','superfastseo_memcached_set','superfastseo_auto_memcached_menu_callback'
);   
}
...
function superfastseo_tags_set_menu_callback(){
    echo '<h3>TAGS优化设置&nbsp;&nbsp;&nbsp;<span style="font-size:13px;"><a href = "https://www.geekercode.com/wp/148.html" target="_black">使用教程</a></span></h3>'; 
    echo '<hr>';
    include_once(SUPERFASTSEO_PLUGIN_DIR . '/modules/seo/tags-link.php');
}
...
function superfastseo_smtp_set_menu_callback(){
    echo '<h3>SMTP邮件服务设置&nbsp;&nbsp;&nbsp;<span style="font-size:13px;"><a href = "https://www.geekercode.com/wp/149.html" target="_black">使用教程</a></span></h3>'; 
    echo '说明：SMTP 设置后自动发送邮件。<hr>';
    include_once(SUPERFASTSEO_PLUGIN_DIR . '/modules/smtp/smtp-set.php');
}

function superfastseo_auto_memcached_menu_callback(){
    echo '<h2>全自动生成 memcached 设置</h2>'; 
    echo '说明：全自动生成 memcached 设置。&nbsp;&nbsp;<strong><a href = "https://www.geekercode.com/wp/146.html" target="_black">使用教程</a></strong><hr>';
    include_once(SUPERFASTSEO_PLUGIN_DIR . '/modules/cache/memcached-set.php');
}
?>