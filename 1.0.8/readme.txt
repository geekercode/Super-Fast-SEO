...
Tags:SEO,SEO优化插件,数据库查询优化,优化加速,关键词内链,过滤正文HTML代码,蜘蛛爬取,图片压缩,百度实时主动推送,网站地图,TAGS标签内链,SMTP邮件设置,TAGS优化配置
...
== Description ==
基于WordPress的国产SEO优化插件，代码精炼、超快、功能强大！Super Fast SEO是设置最简单、功能多和全的中文SEO插件。主要功能：基础优化加速、正文过滤HTML、图片压缩处理、安全增强、蜘蛛爬取控制、数据库查询优化(支持百万级数据)、图片压缩处理等功能！
